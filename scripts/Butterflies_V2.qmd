...
For our project, we decided to work with a dataset called *Data for butterfly near-infrared adaptation research* which we found on **Dryad**.
...
longdat[,c(1:2, 8, 14:16)] %>% 
  ...
  scale_color_manual(values = c("B" = "#53599A", "E" = "#6D9DC5", 
                                "T" = "#80DED9")) +
  theme_classic() + 
